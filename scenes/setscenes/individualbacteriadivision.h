#include <random>
class IndividualBacteriaDivision : public Scene
{

public:
	IndividualBacteriaDivision(const char* name) : Scene(name) {}
	...
	virtual void Initialize()
	{
		...
		float length = 1.0f; // Length of the 'rod' cells
		numbersegments = 5;
		/////////////////////////////////////////////////////////////
	...
	void Update()
	{
		...
		for (int i = 0; i < cellCount; i++)
		{
			if (g_bac[i].divide == 1 & mFrame > 100)
			{
				DivideCells(i);
			}
		}
